...
public class MoviesPopular extends AppCompatActivity implements MovieAdapter.ListItemClickListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    String popularQuery, overview, thumbnailURL, title, movie_id, voteAverage, releaseDate;
    int counter = 0;
    JSONArray jsonArray;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = (DrawerLayout) findViewById(R.id.popular_layout);
        ...
        if (savedInstanceState != null){
            ...
            popularQuery = new Uri.Builder().scheme("http")
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.top_rated){
            ...
            drawer.closeDrawers();
            Toast.makeText(getBaseContext(), "Already sorted by popular", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
    ...
    public void setUp(){
        ...
        JsonObjectRequest request = new JsonObjectRequest(popularQuery, null,
